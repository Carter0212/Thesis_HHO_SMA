...
import numpy as np
from Alg import HHO,BaseSMA,OriginalSMA,HHO_SMA,GA,HHO_SMA_ch,HHO_SMA_Chaos,HHO_SMA_DE,Random
import math
import Alg
import random
...
if __name__ == "__main__":
    ...
    Random_1 = Random(function,dimension,iteration,problem_size,lb,ub,compare_func,compare_Best_bool)
    Random_1.mutil_run(Start_run_times,End_run_times,random_seed_list)
    ...
    # ax_EE.plot(Random_1.avg_convergence,label='SMA')

    # # fig_EE.legend()
    # ax_violation.plot(Random_1.avg_constrained_violation_curve,label='GA')
