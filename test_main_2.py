...
if __name__ == "__main__":
    ...
    # hhoSMA_DE_1.mutil_run(10,End_run_times,random_seed_list)
    ...
    # hhoSMA_1.mutil_run(9,End_run_times,random_seed_list)
    ...
    hhoSMA_chaos_1 = HHO_DE_Chaos(function,dimension,iteration,problem_size,lb,ub,compare_func,compare_Best_bool)
    hhoSMA_chaos_1.mutil_run(17,25,random_seed_list)
