...
def HHO(objf,lb,ub,dim,SearchAgents_no,Max_iter,is_discrete):
...
if __name__ == "__main__":
    ...
    ub=1000
    Max_iter=10
    is_discrete=[i for i in range(dim) if i % 2 > 0]
    HHO(Rosenbrock, lb, ub, dim, SearchAgents_no, Max_iter,is_discrete)
